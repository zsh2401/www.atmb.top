...
import { StdLayout,BVideo } from '../../lib/controls';
class PageAbout extends React.Component{
    ...
    render(){
        return <StdLayout>
            ...
            <br/><br/>
            <BVideo src="//player.bilibili.com/player.html?aid=41336181&amp;cid=72599777&amp;page=1"></BVideo>
        </div>
        </StdLayout>
    }
}
ReactDOM.render(<PageAbout/>,document.querySelector("#app"));